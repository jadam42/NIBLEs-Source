Introduction
------------
NIBLEs is a Python package designed to simulate magnetic resonance (MR) experiments through numerically solving the Bloch equations. NIBLEs is intended to assist with the initial development of MR hardware by establishing optimal MR scanner parameters for a known measurement. As such, it includes the capacity to simulate non-ideal applied magnetic fields and field-dependent relaxation times.
